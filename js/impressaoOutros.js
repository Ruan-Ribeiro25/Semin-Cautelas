function imprimir() {
    ...
    let valorSelecionado = "";
      ...
      if (document.getElementById('retiradadeequipamento').checked) {
        valorSelecionado = "Retirada de Equipamento";
      } else if (document.getElementById('devolucaodeequipamento').checked) {
        valorSelecionado = "Devolução de Equipamento";
      }
    let cautelaDigital = document.getElementById('discriminacao').value;
    ...
    let conteudoHTML = `
      <html>
      <head>
        <title>Prefeitura Municipal de Itajubá</title>
        <style>
          p { font-weight: arial; }
        </style>
      </head>
      <body>
        ...
        <p><strong>Patrimonio:</strong> ${patrimonioDigital}</p>
        ...
        <p>-----------------------------------------------------------------------------------------------------------------------------</p>
        <p><strong>REGISTRO DE CAUTELA N°</strong> ${numeroDigital}</p>        <p><strong>Recebedor:</strong> ${nomeDigital}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>Matrícula:</strong> ${matriculaDigital}</p>
        <p><strong>Secretaria:</strong> ${secretariaDigital}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>Departamento: </strong>${departamentoDigital}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Função: </strong>${funcaoDigital} </p>
        <p><strong>Email:</strong> ${emailDigital}</p>
        <p><strong>Discriminação:</strong> ${cautelaDigital}</p>
        <p><strong>Patrimonio:</strong> ${patrimonioDigital}</p>
