function imprimir() {
    ...
    let valorSelecionado = "";
      ...
      if (document.getElementById('retiradadenotebook').checked) {
        valorSelecionado = "Retirada de Notebook";
      } else if (document.getElementById('devolucaodenotebook').checked) {
        valorSelecionado = "Devolução de Notebook";
      }
