function imprimir() {
    ...
    let conteudoHTML = `
      ...
      <body>
        ...
        <p><strong>DECLARO</strong> que ${Entregue} o(s) equipamento(s) aqui descrito(s) e estar plenamente ciente da responsabilidade por mim assumida quanto ao recebimento e a utilização do(s) mesmo(s), bem como a não cessão ou transferência destes a terceiros.
          <br>
